...
namespace CollegeManagementSystem
{
    public class Global
    {
        ...
        // Database için Server Girişleri
        public static string ServerName = @"DESKTOP-TABV8IB";
        public static string SUserId = @"DESKTOP-TABV8IB";
        public static string SPassword = "";
        public static string Database="College";

        // Uygulama için Kullanıcı Girişleri
